            ...
            <ul class="nav navbar-nav">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li>
                        <a href="#">
                          <i class="fa fa-users text-aqua"></i> 5 Membros cadastrados hoje
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-warning text-yellow"></i> 30 vendas feitas
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-users text-red"></i> 5 Membros sairam hoje
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-shopping-cart text-green"></i> 25 compras feitas
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-user text-red"></i> Voçê mudou seu nome
                        </a>
                      </li>
                    </ul>
                  </li>
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Vinicius Pinto</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
